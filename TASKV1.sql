create or replace task RETAIL.BRONZEST.DEAB101
  ...
  -- Merge data from BRONZEST.AB to SILVERST.AB
  ...
  -- Aggregate revenue from SILVERST.AB into GOLDST.AB
  INSERT INTO RETAIL.GOLDST.AB (CUSTOMERNAME, REVENUE)
  SELECT CUSTOMERNAME, SUM(SALES)
  FROM RETAIL.SILVERST.AB
  GROUP BY CUSTOMERNAME;

  -- Mark files as processed and truncate the BRONZEST.AB table
